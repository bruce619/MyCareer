# Generated by Django 2.2.5 on 2020-08-18 10:10
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cv', nueoffshore.extra.ContentTypeRestrictedFileField(upload_to=nueoffshore.models.user_directory_path, validators=[nueoffshore.models.validate_file_extension])),
                ('degree', models.CharField(blank=True, choices=[('PhD', 'PhD'), ('Mphil', 'Mphil'), ('M.Sc', 'M.Sc'), ('MBA', 'MBA'), ('MBBS', 'MBBS'), ('B.Sc', 'B.Sc'), ('HND', 'HND'), ('OND', 'OND'), ('Diploma', 'Diploma'), ('NCE', 'NCE'), ('SSCE/WAEC', 'SSCE/WAEC'), ('Others', 'Others')], max_length=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('certification', nueoffshore.extra.ContentTypeRestrictedFileField(default='default.pdf', upload_to=nueoffshore.models.user_directory_path, validators=[nueoffshore.models.validate_file_extension])),
